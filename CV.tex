...
%      \CVItemListEnd
    ...
    %   {Developing new models and algorithms for location selection, location-allocation analysis, routing, regionalization problems}{}
    % \CVSubheading
    %   {GeoAI}{}
    ...
    %       \CVSubheadingSimple
      ...
      {Spatial optimisation}{}
      \CVItemListStart
        \CVItem{Developing new models and algorithms for location selection, location-allocation analysis, routing, regionalization problems}        
      \CVItemListEnd
     \CVSubheadingSimple
      {GeoAI}{}
      \CVItemListStart
        \CVItem{Developing data-driven GeoAI models}        
        \CVItem{with applications in crime prediction and transport flow prediction}
      \CVItemListEnd
     \CVSubheadingSimple
      {Urban mobility}{}
      \CVItemListStart
        \CVItem{Applying econometrics and machine learning models to understand travel mode and purpose in urban contexts}        
      \CVItemListEnd
     \CVSubheadingSimple
      {Health GIS}{}
      \CVItemListStart
        \CVItem{Using GIS methods to understand the spatio-temporal patterns of infectious disease (e.g. Covid-19)}
        \CVItem{Evaluating the performance of control measures (e.g. the varination of vaccination uptake rate and its socio-economic determinants)}
      \CVItemListEnd
  \CVSubHeadingListEnd
